...
function dtps_multi_role_new_role_default_capabilities() {
    ...
    return apply_filters( 'dtps_multi_role_new_role_default_capabilities', array( 'read' ) );
}
...
function dtps_multi_role_new_role_default_caps() {
    ...
    return apply_filters( 'dtps_multi_role_new_role_default_caps', array( 'read' => true ) );
}
